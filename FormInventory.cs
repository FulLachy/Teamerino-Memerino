...
namespace Teamerino_Memerino
{
    public partial class FormInventory : Form
    {
        ...
        {
            DGV_Inv.ClipboardCopyMode = DataGridViewClipboardCopyMode.EnableWithoutHeaderText;
            DGV_Inv.SelectAll();
            DataObject toSave = DGV_Inv.GetClipboardContent();
            System.IO.File.WriteAllText("...//...//Resources//Items//inventory.txt", toSave.GetText(TextDataFormat.CommaSeparatedValue));
        }
    }
}
